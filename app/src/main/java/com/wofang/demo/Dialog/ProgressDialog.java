...
public class ProgressDialog extends AlertDialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mProgressStyle == STYLE_HORIZONTAL) {
			 ...
			 * R.layout.progress_dialog), null); mProgress = (ProgressBar)
			 * view.findViewById(R.id.progress); mMessageView = (TextView)
			 * view.findViewById(R.id.message); setView(view);
			 */
		}
		a.recycle();
		if (mMax > 0) {
	...
	public void setProgressNumberVisibility(boolean isVisibility) {
		if (isVisibility) {
