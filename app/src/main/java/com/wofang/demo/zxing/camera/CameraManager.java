...
package com.wofang.demo.zxing.camera;
...
import com.wofang.demo.zxing.activity.CaptureActivityHandler;
import com.wofang.demo.zxing.activity.Constants;
...
//    }
    ...
    public void switchFlashLight(CaptureActivityHandler handler) {
        ...
        if (flashMode.equals(Camera.Parameters.FLASH_MODE_TORCH)) {
            ...
            msg.what = Constants.FLASH_CLOSE;


        } else {
            /*打开闪光灯*/
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
            msg.what = Constants.FLASH_OPEN;
        }
